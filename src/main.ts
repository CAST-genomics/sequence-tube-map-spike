...
import { catalogEntries, entryForUrl, type NodeTable } from './nodeCatalog.ts'
import { mountTubeMapSurface } from './tubeMapSurface.ts'

const DEFAULT_URL = '/stm-chr1-25331046-25331646.svg'
const FIXTURE_LABEL = 'fixture · chr1:25,331,046-25,331,646 · 600 bp'
...
const entries = catalogEntries(nodeTable as NodeTable)
...
function fillChooser(): void {
    chooser.append(option(DEFAULT_URL, FIXTURE_LABEL))
